Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "startup_volunteers_production"
  ...
  config.action_mailer.default_url_options = { host: 'siapbantu.com', protocol: 'http' }
  ...
  email: {
    email_prefix: '[Siapbantu] ',
    sender_address: %{"Siapbantu" <no-reply@siapbantu.com>},
