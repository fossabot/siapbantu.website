class SuccessStoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @success_story.save
        format.html { redirect_to @success_story, notice: 'Cerita sukses berhasil dibuat.' }
  ...
  def update
    respond_to do |format|
      if @success_story.update(success_story_params)
        format.html { redirect_to @success_story, notice: 'Cerita sukses berhasil diupdate.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to success_stories_url, notice: 'Cerita sukses ini berhasil dihapus.' }
